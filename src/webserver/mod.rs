...
pub async fn start_server(
    ...
    #[openapi(
        ...
        components(schemas(
            ...
            contract::ConfInfoEntry,
            contract::ConfInfoEntryType,
            contract::ConfInfoEntryString,
            contract::ConfInfoEntryInt,
            contract::ConfInfoEntryIntRange,
            contract::ConfInfoEntryFloat,
            contract::ConfInfoEntryFloatRange,
            contract::ConfInfoEntryJSON,
            contract::ConfInfoEntryChoiceList,
