...
pub trait IModule {
    fn obtain_device_conn_info(&mut self) -> Result<model::ConfInfo, CommonError>;
    fn connect_device(&mut self, confs: Vec<model::ConfEntry>) -> Result<(), CommonError>;
    fn obtain_device_conf_info(&mut self) -> Result<model::ConfInfo, CommonError>;
    fn configure_device(&mut self, confs: Vec<model::ConfEntry>) -> Result<(), CommonError>;
